...
function Interface() {
  ...
  useEffect(() => {
    async function fetchUser() {
      try {
        ...
        const response = await axios.get(`https://ample-courage-production.up.railway.app/api/User/${userId}`, {
          headers: {
  ...
  useEffect(() => {
    ...
    const connection = new signalR.HubConnectionBuilder()
      .withUrl("https://ample-courage-production.up.railway.app/chathub")
  ...
  function getChat() {
    ...
    axios.post(`https://ample-courage-production.up.railway.app/api/Chat?userId=${userId}`)
      .then(response => {
  ...
  function handleSend(e) {
    ...
    axios.post("https://ample-courage-production.up.railway.app/api/Message", newMessage)
      .then(response => {
  ...
  function getMoreMessages(e) {
    ...
    axios.get("https://ample-courage-production.up.railway.app/api/Message", { params: { id: activeChat.recentMessages[0].id - 1, chatId: activeChat.id, userId: userRef.current.id } })
      .then(response => {
        console.log(activeChat);
  ...
  function handleLeave(id) {
    axios.delete(`https://ample-courage-production.up.railway.app/api/Chat/${id}`).then(response => {
